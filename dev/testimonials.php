<?php $webPath = ""; ?>
<?php $pageID = "test-string-testimonials.php"; ?>
	            ...
	            <a class="business-phone btn" href="tel:+44-775-7998277">
                    ...
                    <nav id="headerMenu">
                        <div class="menu-menu-1-container"><ul id="menu-menu-1" class="menu sf-js-enabled"><li id="menu-item-25" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-25"><a href="http://virtualkristine.com/">Home</a></li>
                                <li id="menu-item-24" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-24"><a href="http://virtualkristine.com/services/">Services</a></li>
                                ...
                                <li id="menu-item-22" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-10 current_page_item menu-item-22"><a href="http://virtualkristine.com/testimonials/">Testimonials</a></li>
