<?php $webPath = ""; ?>
<?php $pageID = "test-string-contact.php"; ?>
	            ...
	            <a class="business-phone btn" href="tel:+44-775-7998277">
                    ...
                    <nav id="headerMenu">
                        <div class="menu-menu-1-container"><ul id="menu-menu-1" class="menu sf-js-enabled"><li id="menu-item-25" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-25"><a href="http://virtualkristine.com/">Home</a></li>
                                ...
                                <li id="menu-item-21" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-12 current_page_item menu-item-21"><a href="http://virtualkristine.com/contact-me/">Contact Me</a></li>
                            </ul></div>            </nav>
                </header>
